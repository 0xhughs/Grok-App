...
Dispatch ID / launch state / input identity: `D03-PLAN-1` / launching / candidate `2a3620d1…390b` (code HEAD `fd142233`), baseline `2a3620d1…390b`, contract pending recompute after this page, draft `D03-DRAFT-1`
